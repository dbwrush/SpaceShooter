...
public class EnemyCarrier extends Actor{
    ...
    private static int laserStrength = 16, fireDelay = 10, spawnDelay = 240, pointValue = 1000, defaultHealth = 100, turret1XOffset = 8, turret2XOffset = 54, turret1YOffset = 100, turret2YOffset = 66;
